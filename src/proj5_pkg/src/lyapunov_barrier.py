...
class TurtlebotBarrierVision:
    ...
    def evalr1(self, u, t, qeDot = None):
        """
    ...
    def evalr2(self, u, t, qeDot = None):
        """
        Evaluate the CBF and its derivatives. 
        Inputs:
        ...
        # qeDot = self.observerEgo.get_vel().reshape((3, 1))
    ...
    def eval(self, u, t, qeDot = None, option = 2):
        if option == 1:
            return self.evalr1(u, t, qeDot)
        else:
            return self.evalr2(u, t, qeDot)
