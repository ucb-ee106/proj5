...
from controller import Controller, TurtlebotFBLin, TurtlebotCBFQP, TurtlebotCBFQPDeadlock
...
def task_controller():
  ...
  controller = TurtlebotCBFQPDeadlock(observer, barriers, trajectory, frequency, uBounds) #Actual goal is to not have deadlock :)
